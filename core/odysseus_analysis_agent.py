...
7. **OVERVIEW**: Strip away the details. In plain language, explain
...
8. **HOW_IT_WORKS**: Explain how the pieces fit together to produce that big
...
{{
  ...
  "overview": "big-picture what/how/why in plain language",
  "how_it_works": "how each file/module fits together, code-wise and script-wise"
}}
